...
{
    public abstract class CachingDataCollector<TCollectionNode, TEndpointProgressTableEntity> where TCollectionNode : CollectionNode
                                                                                          where TEndpointProgressTableEntity : ProgressDataTableEntity
    {
        ...
        public CachingDataCollector(CollectorBase<TCollectionNode> collector, ITelemetryClient telemetryClient)
        {
